...
export default function ModelRow({ model, fullModel, alias, copied, onCopy, testStatus, testError, isCustom, isFree, onDeleteAlias, onTest, isTesting, onDisable, caps }) {
